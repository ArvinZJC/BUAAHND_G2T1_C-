// L4_A.pdf, Assignment 2, arithmetic learning program for primary students
...
int number1 = 50, number2 = 51, result, totalCount = 0, correctCount = 0; // declare global variables and initialise most of them
...
void Addition()
{
	...
	{		
		...
		cout << "Excercise " << count << ": " << number1 << " + " << number2 << " = ";
		cin >> result;
...
void OutputReport()
{
	...
	{
		double accuracy = (double)correctCount * 100 / totalCount; // calculate the accuracy after doing some exercises

		cout.setf(ios::fixed);
		cout << "Report:\n"
			 << "  You have finished " << totalCount << " exercises.\n"
			 << "  " << correctCount << " of them is/are correctly done.\n"
