// L3_A.pdf, Assignment 2, parking charge calculator
...
void CalculateTotalCharge(int hourlyCharge, int dailyCharge_max)
{
	...
	// 30 < minute ≤ 60 is regarded as 60 minutes (1 hour)
	if (minute > 30)
		time = hour + 1;
	else if (minute == 0)
		time = hour;
...
int main()
{
	...
	while (selection != 'Q' || selection != 'q')
	{
		...
		cout << "Enter your selection (A/B/Q, the lowercase letter is also accepted): ";
		cin >> selection;
		cout << endl;
